        ...
        <div className="rounded-lg border-2 border-[#DFE9F1] px-3 py-4">
          ...
          <div>
            ...
            <div className="mt-2 text-sm font-[300]">
              Only just missed last start, finishing a neck back from the winner
              at Trentham and comes back to race at a country level. Rates as
              one of the key chancesOnly just missed last start, finishing a
              neck back from the winner at Trentham and comes back to race at a
              country level. Rates as one of the key chances
            </div>
          </div>
        </div>
      </div>
